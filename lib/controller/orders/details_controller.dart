...
class OrdersDetailsController extends GetxController {
  ...
  intialData() {
    if (ordersModel.ordersType == "0" && ordersModel.addressLat != null) {
      cameraPosition = CameraPosition(
      ...
      markers.add(Marker(
          markerId: MarkerId("1"),
          position: LatLng(double.parse(ordersModel.addressLat! as String),
              double.parse(ordersModel.addressLong! as String))));
    }
  }
